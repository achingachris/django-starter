"""
Django settings for chrisdevcode-django-templare project.
...
ROOT_URLCONF = "chrisdevcode.urls"
...
WSGI_APPLICATION = "chrisdevcode.wsgi.application"
...
# Local development defaults to SQLite (no DATABASE_URL needed).
# Production sets DATABASE_URL (e.g. Postgres) in the environment, which takes precedence.
...
EMAIL_SUBJECT_PREFIX = "[chrisdevcode-django-templare] "
...
SPECTACULAR_SETTINGS = {
    "TITLE": "chrisdevcode-django-templare",
...
PROJECT_METADATA = {
    "NAME": gettext_lazy("chrisdevcode-django-templare"),
